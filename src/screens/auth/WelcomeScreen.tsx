...
const WelcomeScreen = ({ navigation }: { navigation: any }) => {
  return (
    <SafeAreaView className="bg-[--color-surface]">
      ...
      <View className="w-full h-full flex justify-between items-center bg-[--color-surface] px-8 pb-5">
        ...
        <View className="flex flex-col items-center justify-center gap-[16px] w-full">
          <TouchableOpacity
            className="bg-[--color-container-dark] w-full p-5 flex justify-center items-center rounded-[10px]"
            onPress={() => navigation.navigate("AuthNavigator_SignUpScreen")}
          >
            <Text
              className="text-[--color-on-container-dark] text-[17px] font-Poppins_Black font-bold"
              onPress={() => navigation.navigate("AuthNavigator_SignUpScreen")}
            >
              Create Account
            </Text>
          ...
          >
            <Text className="text-[--color-container-dark] text-[17px] font-Poppins_Regular font-bold">
              Sign In
            </Text>
          </TouchableOpacity>
        </View>
