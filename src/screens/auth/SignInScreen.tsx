      ...
      <View className="w-full h-full flex justify-start items-center bg-surface px-8">
        ...
        <View className="w-full flex justify-center items-center mt-[70px] gap-5">
          <View className="w-full flex justify-center items-start">
            <Text className="mx-[4px] text-[--color-on-surface] font-Poppins_Regular">
              Email
            </Text>
            <TextInput
          ...
          <View className="w-full flex justify-center items-start mt-8">
            <TouchableOpacity
              className="bg-[--color-container-dark] w-full p-5 flex justify-center items-center rounded-full"
            ...
            <View className="flex flex-row items-center gap-2 justify-center mt-4 px-5">
              <Divider className="flex-1 border-[--color-on-surface] border-[0.8px]" />
              <Text className="text-[--color-on-surface]">or</Text>
              <Divider className="flex-1 border-[--color-on-surface] border-[0.8px]" />
            </View>
            <View className="w-full flex justify-center items-start gap-4 mt-4">
              <TouchableOpacity
                ...
                <Image
                  ...
                  resizeMode="contain"
                />
                <Text className="text-[--color-black] text-[17px] font-Poppins_Regular">
                  Sign in with Google
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
            ...
            <View className="flex flex-row items-center justify-center mt-10 w-full">
              <Text className=" text-[--color-on-surface-container]">
